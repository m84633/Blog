        ...
        <div class="row">
          ...
          <div class="offset-lg-1 col-lg-8">
            ...
            <div class="card card-secondary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="POST" action="{{ route('admin.tags.update',$tag->slug) }}">
                @csrf
                @method('PATCH')
                <div class="card-body">
                	<div class="row">
		                  ...
		                  <div class="col-lg-6 form-group">
		                    ...
		                    <input name="slug" value="{{ $tag->slug }}" type="text" class="form-control" id="exampleInputPassword1" >
		                  </div>
                    </div>
