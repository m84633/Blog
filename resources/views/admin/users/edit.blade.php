                ...
                <div class="card-body">
                	<div class="row">
		                  <div class="col-lg-6 form-group">
		                    ...
		                    <input name="name" type="text" class="form-control" id="exampleInputEmail1" value="@if(old('name')){{ old('name') }}@else{{ $user->name }}@endif">
		                  </div>
                      <div class="col-lg-6 form-group">
                        <label for="exampleInputEmail1">電子信箱</label>
                        <input name="email" type="email" class="form-control" id="exampleInputEmail1" value="@if(old('email')){{ old('email') }}@else{{ $user->email }}@endif">
                      </div>
		                  <div class="col-lg-6 form-group">
                      ...
                      <div class="col-lg-6 form-group">
                        ...
                        <input name="confirm_password" type="password" class="form-control" id="exampleInputPassword1" value="@if(old('password')){{ old('password') }}@else{{ $user->password }}@endif">
                      </div>
